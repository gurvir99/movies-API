...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (activeForm === "signIn") {
      try {
        const res = await API.post("/api/users/login", signInData);
      ...
      try {
        ...
        toast.success(
          res.data.message || "Sign Up Successful! Please Sign In."
        );
      ...
      <div className="auth-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            placeholder="Email"
            value={
              activeForm === "signIn" ? signInData.email : signUpData.email
            }
            onChange={
              activeForm === "signIn" ? handleSignInChange : handleSignUpChange
            }
            required
          />
          <input
        ...
        <p>
          ...
          <span
            onClick={() =>
              handleToggle(activeForm === "signIn" ? "signUp" : "signIn")
            }
          >
